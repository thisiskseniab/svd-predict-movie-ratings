...
def display_profile():
    ...
    for r in recommendations:
        print "recommendations", r.rating_score
        fix_unicode_movie(r.movie)

    recommendations = filter(lambda r: r.human_score > 1, recommendations)
    recommendations = sorted(recommendations, key=lambda r: r.ratings_score, reverse=True)[:10]
...
def overview():
    ...
    recommendations_1 = sorted(recommendations_1, key=lambda r: r_1.rating_score, reverse=True)[:5]
    #2
    ...
    recommendations_2 = sorted(recommendations_2, key=lambda r: r_2.rating_score, reverse=True)[:5]
    #3
    ...
    recommendations_3 = sorted(recommendations_3, key=lambda r: r_3.rating_score, reverse=True)[:5]
